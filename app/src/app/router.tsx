...
import { PublicoReservaConfirmadaPage } from '../features/publico/PublicoReservaConfirmadaPage'
...
export const router = createBrowserRouter([
  ...
  {
    path: '/publico/reserva/confirmada',
    element: <PublicoReservaConfirmadaPage />,
  },
  {
